...
var _huggablemonad$fcc_local_weather$Location$Location = F4(
	function (a, b, c, d) {
		return {city: a, countryCode: b, latitude: c, longitude: d};
	});
var _huggablemonad$fcc_local_weather$Location$location = A5(
	_elm_lang$core$Json_Decode$object4,
	_huggablemonad$fcc_local_weather$Location$Location,
...
var _huggablemonad$fcc_local_weather$Location$get = A2(_evancz$elm_http$Http$get, _huggablemonad$fcc_local_weather$Location$location, 'https://ipapi.co/json/');

var _huggablemonad$fcc_local_weather$Weather$cssButton = _elm_lang$html$Html_Attributes$classList(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'btn', _1: true},
			{ctor: '_Tuple2', _0: 'btn-default', _1: true},
			{ctor: '_Tuple2', _0: 'btn-lg', _1: true}
		]));
var _huggablemonad$fcc_local_weather$Weather$cssToggleDisplay = F2(
	function (iframeUnits, units) {
		return _elm_lang$core$Native_Utils.eq(iframeUnits, units) ? 'inline' : 'none';
	});
var _huggablemonad$fcc_local_weather$Weather$cssIframe = function (value) {
	return _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'border-width', _1: '0'},
				{ctor: '_Tuple2', _0: 'display', _1: value},
				{ctor: '_Tuple2', _0: 'height', _1: '245px'},
				{ctor: '_Tuple2', _0: 'width', _1: '100%'}
			]));
};
var _huggablemonad$fcc_local_weather$Weather$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _huggablemonad$fcc_local_weather$Weather$toUrl = function (loc) {
	var name = A2(
		_elm_lang$core$Basics_ops['++'],
		'&name=',
		A2(
			_elm_lang$core$Basics_ops['++'],
			loc.city,
			A2(_elm_lang$core$Basics_ops['++'], ', ', loc.countryCode)));
	var lon = A2(
		_elm_lang$core$Basics_ops['++'],
		'&lon=',
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'https://forecast.io/embed/',
		A2(
			_elm_lang$core$Basics_ops['++'],
			lat,
			A2(_elm_lang$core$Basics_ops['++'], lon, name)));
};
var _huggablemonad$fcc_local_weather$Weather$Model = F2(
	function (a, b) {
		return {location: a, units: b};
	});
var _huggablemonad$fcc_local_weather$Weather$US = {ctor: 'US'};
var _huggablemonad$fcc_local_weather$Weather$SI = {ctor: 'SI'};
var _huggablemonad$fcc_local_weather$Weather$ChangeUnits = {ctor: 'ChangeUnits'};
var _huggablemonad$fcc_local_weather$Weather$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$src(model.location),
						_huggablemonad$fcc_local_weather$Weather$cssIframe(
						A2(_huggablemonad$fcc_local_weather$Weather$cssToggleDisplay, _huggablemonad$fcc_local_weather$Weather$US, model.units))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(_elm_lang$core$Basics_ops['++'], model.location, '&units=si')),
						_huggablemonad$fcc_local_weather$Weather$cssIframe(
						A2(_huggablemonad$fcc_local_weather$Weather$cssToggleDisplay, _huggablemonad$fcc_local_weather$Weather$SI, model.units))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_huggablemonad$fcc_local_weather$Weather$ChangeUnits),
						_huggablemonad$fcc_local_weather$Weather$cssButton
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Change units')
					]))
			]));
};
var _huggablemonad$fcc_local_weather$Weather$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _huggablemonad$fcc_local_weather$Weather$FetchSucceed = function (a) {
	return {ctor: 'FetchSucceed', _0: a};
};
var _huggablemonad$fcc_local_weather$Weather$getLocation = A3(_elm_lang$core$Task$perform, _huggablemonad$fcc_local_weather$Weather$FetchFail, _huggablemonad$fcc_local_weather$Weather$FetchSucceed, _huggablemonad$fcc_local_weather$Location$get);
var _huggablemonad$fcc_local_weather$Weather$init = {
	ctor: '_Tuple2',
	_0: A2(_huggablemonad$fcc_local_weather$Weather$Model, 'loading.html', _huggablemonad$fcc_local_weather$Weather$US),
	_1: _huggablemonad$fcc_local_weather$Weather$getLocation
};
var _huggablemonad$fcc_local_weather$Weather$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'GetWeather':
				return {ctor: '_Tuple2', _0: model, _1: _huggablemonad$fcc_local_weather$Weather$getLocation};
			case 'FetchSucceed':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							location: _huggablemonad$fcc_local_weather$Weather$toUrl(_p0._0)
						}),
			...
			case 'FetchFail':
				return {
					ctor: '_Tuple2',
					_0: A2(_huggablemonad$fcc_local_weather$Weather$Model, 'Fetch failed.', model.units),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return _elm_lang$core$Native_Utils.eq(model.units, _huggablemonad$fcc_local_weather$Weather$SI) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{units: _huggablemonad$fcc_local_weather$Weather$US}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{units: _huggablemonad$fcc_local_weather$Weather$SI}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _huggablemonad$fcc_local_weather$Weather$GetWeather = {ctor: 'GetWeather'};

var _huggablemonad$fcc_local_weather$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _huggablemonad$fcc_local_weather$Weather$init, view: _huggablemonad$fcc_local_weather$Weather$view, update: _huggablemonad$fcc_local_weather$Weather$update, subscriptions: _huggablemonad$fcc_local_weather$Weather$subscriptions})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _huggablemonad$fcc_local_weather$Main$main === 'undefined' ? null : _huggablemonad$fcc_local_weather$Main$main);
